...
import { fetchFilters, changeFilters, fetchSort, changeSort } from "../../store/FilterSlise"
        ...
        <div className="container">
            <div className="content__top">
                ...
                <div className={classNames({'sort__popup': true, 'sort__popup-none': activePopap})}>
                    <ul>
                        {
                            sortFilters.map(({id, name}) => <li 
                                                            key={id} 
                                                            className={classNames({'active': name === activeSort})}
                                                            onClick={() => {dispatch(changeSort(name)); onClickPopap()}} 
                                                            >{name}
                                                        </li>)
                        }
                    </ul>
