...
const Cart = ({cartElement}) => {
  ...
  const elements = createItems(cartElement)
        ...
        <div className="cart">
          <div className="cart__top">
            ...
            Корзина</h2>
              ...
              <div className="cart__clear" onClick={() => dispatch(deleteCarts())}>
          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              <span> Всего пицц: <b>{itemCart} шт.</b> </span>
              <span> Сумма заказа: <b>{cartAllSum} ₽</b> </span>
            </div>
